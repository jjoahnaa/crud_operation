            ...
            <div>
                <form action="../controllers/createProduct.php" method="POST">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="produc_tName" name="product_name" required>
                    </div>
                    <div class="mb-3">
        ...
        <table class="table">
            ...
            <tbody class="table-group-divider">
                ...
                <tr>
                    ...
                    <td>
                        <a class="btn btn-outline-danger btn-sm" href="../controllers/deleteProductController.php?id=<?= $fetch['product_id']; ?>">Delete</a>
                        <a class="btn btn-outline-primary btn-sm" href="edit.php?id=<?= $fetch['product_id']; ?>">Edit</a>
                    </td>
                </tr>
                <?php
                }
